...
def extract_from_json(clinical_study):
    ...
    extracted_json.update({
        "Arms group 0 label": f"""{safe_get(arms_interventions_module, ["armGroups"])[0]["label"]}""",
        "Arms group 0 type": f"""{safe_get(arms_interventions_module, ["armGroups"])[0]["type"]}""",
        # "Arms group 0 description": f"""{safe_get(arms_interventions_module, ["armGroups"])[0]["description"]}"""
        "Arms group 0 intervention names": f"""{safe_get(arms_interventions_module, ["armGroups"])[0]["interventionNames"]}""",
        "Arms group 1 label": f"""{safe_get(arms_interventions_module, ["armGroups"])[1]["label"]}""",
        "Arms group 1 type": f"""{safe_get(arms_interventions_module, ["armGroups"])[1]["type"]}""",
    #     "Arms group 1 description": f"""{safe_get(arms_interventions_module, ["armGroups"])[1]["description"]}"""
        "Arms group 1 intervention names": f"""{safe_get(arms_interventions_module, ["armGroups"])[1]["interventionNames"]}""",

        "Arms group 0 intervention type": f"""{safe_get(arms_interventions_module, ["interventions"])[0]["type"]}""",
        "Arms group 0 intervention name": f"""{safe_get(arms_interventions_module, ["interventions"])[0]["name"]}""",
        # "Arms group 0 intervention description": f"""{safe_get(arms_interventions_module, ["interventions"])[0]["description"]}"""
        "Arms group 0 intervention labels": f"""{safe_get(arms_interventions_module, ["interventions"])[0]["armGroupLabels"]}""",
        "Arms group 1 intervention type": f"""{safe_get(arms_interventions_module, ["interventions"])[1]["type"]}""",
        "Arms group 1 intervention name": f"""{safe_get(arms_interventions_module, ["interventions"])[1]["name"]}""",
        # "Arms group 1 intervention description": f"""{safe_get(arms_interventions_module, ["interventions"])[1]["description"]}"""
        "Arms group 1 intervention labels": f"""{safe_get(arms_interventions_module, ["interventions"])[1]["armGroupLabels"]}""" ,   
    })
    ...
    try:
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["groupIds"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["groupDescription"]}""",

        extracted_json.update({
        "Primary outcome group identifications": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["groupIds"]}""",
        "Primary outcome group description": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["groupDescription"]}""",
        })
    except: pass

    try:
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["pValue"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["statisticalMethod"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["paramType"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["paramValue"]}""",

        extracted_json.update({
        "Primary outcome group p-value": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["pValue"]}""",
        "Primary outcome group statistical method": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["statisticalMethod"]}""",
        "Primary outcome group statistical method parameter type": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["paramType"]}""",
        "Primary outcome group statistical method parameter value": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["paramValue"]}""",
        })
    except: pass
    
    try:
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["ciPctValue"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["ciPctValue"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["ciLowerLimit"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["ciUpperLimit"]}""",
        f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["estimateComment"]}""",
        extracted_json.update({
        "Primary outcome group confidence interval percentage value": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["ciPctValue"]}""",
        "Primary outcome group confidence interval lower limit": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["ciLowerLimit"]}""",
        "Primary outcome group confidence interval upper limit": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["ciUpperLimit"]}""",
        "Primary outcome group estimate comment": f"""{safe_get(outcome_measures_module, ["outcomeMeasures"])[0]["analyses"][0]["estimateComment"]}""",
        })
    except: pass
